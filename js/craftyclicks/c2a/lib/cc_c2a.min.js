...
function clickToAddress(a) {
    ...
    ccEvent(this.searchObj, "mouseover", function() {
        ...
        1 != b.searchStatus.inCountryMode && a + c == parseInt(this.scrollHeight) && b.showResultsExtra();
...
if (clickToAddress.prototype.search = function(a, b, c) {
    ...
    if ("" !== a) {
        ...
        request.setRequestHeader("Accept", "application/json"), request.onreadystatechange = function() {
            if (4 === this.readyState) if (this.status >= 200 && this.status < 400) {
                if (200 == this.status) {
                    var b = "";
                    try {
                        b = JSON.parse(this.responseText), "undefined" == typeof c || d.searchStatus.lastResponseId <= c ? (d.setProgressBar(1), 
                        d.clear(), d.hideErrors(), d.searchResults = b, d.showResults(), d.focused || d.activeInput.focus(), 
                        d.searchStatus.lastResponseId = c) : console.log(c + ">" + d.searchStatus.lastResponseId + ": " + a), 
                        d.cacheStore(e, b);
                    } catch (f) {
    ...
    if (this.resetSelector(), this.cleanHistory(), a.key = ccData(a, "key"), a.filters = ccData(a, "filters"), 
    a.query = ccData(a, "query"), 0 !== a.key) return this.getAddressDetails(a.key), 
    this.hide(), void this.loseFocus();
    if (null !== a.filters || null !== a.query) {
        var b = getTimeTrack();
        return this.searchStatus.lastSearchId = b, this.search(this.activeInput.value, a.filters, b), 
        this.getFocus(), null !== a.query && (this.activeInput.value = a.query), void (this.activeFilters = a.filters);
    }
    if ("deadend" != a.className) {
        var b = getTimeTrack();
        return this.searchStatus.lastSearchId = b, this.search(this.activeInput.value, b), 
        void this.getFocus();
    }
    ...
    b.searchStatus.inCountryMode = 0, this.getFocus(), "undefined" != typeof this.activeInput.value && "undefined" != typeof this.lastSearch) {
        this.activeInput.value = this.lastSearch, this.activeFilters = {}, this.lastSearch = this.value;
        var f = getTimeTrack();
        this.searchStatus.lastSearchId = f, setTimeout(function() {
            b.searchStatus.lastSearchId >= f && ("" !== b.activeInput.value ? (b.search(b.activeInput.value, b.activeFilters, f), 
            b.cleanHistory()) : b.clear());
        }, 200), this.gfxModeTools.reposition(this, this.activeInput);
    }
    ...
    ccEvent(i, "click", function() {
        0 == j.searchStatus.inCountryMode ? (j.setPlaceholder(1), j.changeCountry(), j.activeInput.value = "", 
        j.hasContent = !0) : (j.setPlaceholder(0), j.searchStatus.inCountryMode = 0, j.hide(!0), 
        j.getFocus(), j.hover = !0);
    });
...
c2a_gfx_modes.mode2 = {
    ...
    this.selectorPos = -1, this.activeInput = "init", this.searchStatus = {
        lastSearchId: 0,
        lastResponseId: 0,
        inCountryMode: 0
    }, this.cache = {}, this.cachePos = -1, this.scrollPosition = 0, this.scrollLimit = 20, 
    this.activeFilters = {}, this.lastSearch = "", this.funcStore = {}, this.setCfg(a, "gfxMode", 1), 
    this.setCfg(a, "baseURL", "https://api.craftyclicks.co.uk/address/1.0", "relay"), 
...
clickToAddress.prototype.setPlaceholder = function(a, b) {
    ...
    this.resultList.innerHTML = "", this.searchStatus = {
        lastSearchId: 0,
        lastResponseId: 0,
        inCountryMode: 0
    };
        ...
        if (0 != h.serviceReady) {
            ...
            if (-1 == b.indexOf(a.keyCode)) {
                if (13 == a.keyCode) {
                    ...
                    return void (1 == h.searchStatus.inCountryMode ? h.selectCountry(c.getAttribute("countryCode")) : h.select(c));
                }
                if (1 == h.searchStatus.inCountryMode) h.changeCountry(this.value); else {
                    0 !== this.value.indexOf(h.lastSearch) && (h.activeFilters = {}), h.lastSearch = this.value;
                    var d = getTimeTrack();
                    h.searchStatus.lastSearchId = d;
                    var e = this.value;
                    setTimeout(function() {
                        h.searchStatus.lastSearchId >= d && ("" !== e ? (h.cleanHistory(), h.search(e, h.activeFilters, d)) : h.clear());
                    }, 200), h.activeDom = h.domLib[g], h.gfxModeTools.reposition(h, f);
                }
            }
        }
    ...
    var c = b.visible;
    if (b.gfxModeTools.reposition(b, a), b.activeInput = a, b.focused = !0, b.show(), 
    "" !== a.value && !c) {
        var d = getTimeTrack();
        b.searchStatus.lastSearchId = d, b.search(a.value, b.activeFilters, d);
    }
